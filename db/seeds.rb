...
po1 = PressOn.create(name:"Lavender Touch",image:"https://img.ltwebstatic.com/images3_pi/2020/08/13/15972989601bf97065e3dc9934dbba3da1c9c7fee3_thumbnail_900x.webp", shape:"coffin",color:"purple", add_on:"Matte", description:"Long,lavender, and coffin ", price:30.50, quantity:10 )
...
po3 = PressOn.create(name: "Fire ",image:"https://i.etsystatic.com/21178056/r/il/996ad7/2056535008/il_1588xN.2056535008_ei1a.jpg", shape:"stiletto",color:"red", add_on:"Matte", description:"Long,red,stiletto shaped", price:30.00, quantity:8 )
...
po5 = PressOn.create(name: "All of the Lights ",image:"https://i.pinimg.com/originals/3b/bd/52/3bbd529e0c5237ca73fc4369f46e8eef.jpg", shape:"coffin",color:"green", add_on:"glow in the darl", description:"Long,coffin shaped nails with an green,glow-in the-dark ombre", price:40.00, quantity: 7)
po6 = PressOn.create(name: "Ying and Yang",image:"https://i.etsystatic.com/22970529/r/il/7b2624/3130214038/il_1588xN.3130214038_i5ye.jpg", shape:"square",color:"pink", add_on:"Design", description:"Medium legnth, square nails composed of pink and white pain with the Ying and Yang Symbol", price:35.00, quantity:11)
po7 = PressOn.create(name: "Peachtree",image:"https://bellyitchblog.com/wp-content/uploads/2020/09/8512E0F9-2FAC-4FF2-8863-F4AD4F4AC189-564x447.jpeg", shape:"coffin",color:"peach", add_on:"Matte", description:"Medium legnth coffin nails with plain peach polish", price:25.00, quantity:4)
po8 = PressOn.create(name: "Fleek",image:"https://m.media-amazon.com/images/I/51Y7c1jHxrL._SY355_.jpg", shape:"round",color:"white", add_on:"glossy", description:"short,white and round", price:15, quantity:25 )
...
po15 = PressOn.create(name: "Midnight Dreams",image:"https://m.media-amazon.com/images/I/71I1snTOr7L._SX679_.jpg", shape:"round",color:"black", add_on:"Matte", description:"Round black and Matte", price:20.00 , quantity:14 )
po16 = PressOn.create(name: "Flaming",image:"https://img.ltwebstatic.com/images3_pi/2020/08/13/15972974972272ddc37480ea31b4a490d2edb2a178_thumbnail_900x.webp", shape:"coffin",color:"white", add_on:"design", description:"Nude background with white flames", price:30.50, quantity:13 )
